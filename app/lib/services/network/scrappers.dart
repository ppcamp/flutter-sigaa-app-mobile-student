...
class Scrappers {
  ...
  static const EmptyScreen = 'you must load some string at first';
  ...
  Future<void> doLogin(LoginPayload login) async {
    ...
    final tree = parseHtmlDocument(content);
  ...
  Future<List<Subjects>> getHomeClasses() async {
    if (currentpage == null) throw EmptyScreen;
...
<script type="text/javascript">	if(window.cmDraw!=undefined) { cmDraw ('menu_form_menu_discente_j_id_jsp_512348736_98_menu', menu_form_menu_discente_j_id_jsp_512348736_98_menu, 'hbr', cmThemeOffice, 'ThemeOffice');}</script><input type="hidden" name="javax.faces.ViewState" id="javax.faces.ViewState" value="j_id3" />
</form>
...
<a id="j_id_jsp_512348736_335:detalharIndiceAcademico" href="#" style="font-size:9px; margin-right:12px;" onclick="if(typeof jsfcljs == 'function'){jsfcljs(document.getElementById('j_id_jsp_512348736_335'),{'j_id_jsp_512348736_335:detalharIndiceAcademico':'j_id_jsp_512348736_335:detalharIndiceAcademico'},'');}return false">Detalhar</a><input type="hidden" name="javax.faces.ViewState" id="javax.faces.ViewState" value="j_id3" />
		...
		<div id="main-docente">
			...
			fcontent[0]="<p class=\"noticia destaque\"><a href=\"#\" id=\"noticia_4780420\">[CURSO] Cisco CCNA M&oacute;dulo 1 &#150; Introdution to Network &#150; Curso de extens&atilde;o</a></p><p class=\"descricao\"><a href=\"#\" style=\"font-weight: normal; text-decoration: none\" id=\"noticia_4780420\">J&aacute; pensou em se especializar em uma &aacute;rea que possui uma alta demanda de m&atilde;o de obra especializada? Est&atilde;o abertas as inscri&ccedil;&otilde;es para o curso de extens&atilde;o Cisco CCNA M&oacute;dulo 1 &#150; Introdution to Network.    Este &eacute; o primeiro dos tr&ecirc;s m&oacute;dulos dos cursos da Cisco (maior fabricante mundial de equipamentos de...</a></p>";

			fcontent[1]="<p class=\"noticia destaque\"><a href=\"#\" id=\"noticia_4731542\">E-mails recebidos e ajustes de matr&iacute;cula</a></p><p class=\"descricao\"><a href=\"#\" style=\"font-weight: normal; text-decoration: none\" id=\"noticia_4731542\">Ol&aacute;s!  Aqui &eacute; Wandr&eacute;. Recebi muitos e-mails com quest&otilde;es relativas &agrave; matr&iacute;culas, troca de turmas, rematr&iacute;cula entre outros. Saliento que n&atilde;o tenho autoriza&ccedil;&atilde;o de responder ou aceitar nenhuma solicita&ccedil;&atilde;o que n&atilde;o seja pelo formul&aacute;rio da PRG: https://docs.google.com/forms/d/e/1FAIpQLSctdT9WRcmvPi_uRHzt...</a></p>";
					...
					<h4> Minhas atividades  </h4>
							...
							<table>
								...
								<tbody>
										...
										<tr class="odd">
											<td style="text-align:center;"> <img src='/sigaa/img/check.png' title='Atividade conclu&#237;da'> </td>
											<td>
										...
										<tr class="">
											<td style="text-align:center;"> <img src='/sigaa/img/prova_mes.png' title='Atividade no m&#234;s atual'> </td>
											<td>
...
<div class="clear"> </div>
	...
	<div style="width: 80%; text-align: center; margin: 0 auto;">
		<a href='/sigaa/ava/index.jsf'>Turma Virtual</a>
	</div>



	<div id="rodape">
		<p>	SIGAA | DTI - Diretoria de Tecnologia da Informa&#231;&#227;o - (35) 3629-1080 | Copyright &copy; 2006-2021 - UFRN - sigaa04.unifei.edu.br.sigaa04
